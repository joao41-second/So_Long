...
/*   Updated: 2024/08/30 11:05:28 by jperpect         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	map_in_img(char **map, t_vars *vars)
{
	...
	set_vars(vars);
	vars->player.player = img_name(vars,
			"./textures/textures/player/sandart/frame_", 7, player);
	vars->slime = img_name(vars, "./textures/textures/slime/slime_", 1, slime);
	vars->player.player_right = img_name(vars,
			"./textures/textures/player/dir_and/frame_", 7, player_right);
	vars->player.player_atak = img_name(vars,
			"./textures/textures/fire_atack/frame_", 10, player_atak);
	vars->player.set_palyer_anime = 0;
	vars->frame = 3;
