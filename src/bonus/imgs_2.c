...
/*   Updated: 2024/08/30 11:06:16 by jperpect         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_imgs	*img_set(t_vars vars, t_imgs *imgs)
{
	...
	imgs[0].img = mlx_xpm_file_to_image(vars.mlx,
			"./textures/textures/special/10.xpm", &width, &height);
	...
	imgs[1].img = mlx_xpm_file_to_image(vars.mlx,
			"./textures/textures/blocks/wall.xpm", &width, &height);
	...
	imgs[3].img = mlx_xpm_file_to_image(vars.mlx,
			"./textures/textures/items/bonus.xpm", &width, &height);
	...
	imgs[4].img = mlx_xpm_file_to_image(vars.mlx,
			"./textures/textures/special/16.xpm", &width, &height);
